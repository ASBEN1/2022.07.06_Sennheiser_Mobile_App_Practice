...
$(function () {
  ...
  <div class="search-box">
    ...
    <form class="search-container">
      ...
      <input type="search" id="search" placeholder="검색" required>

      <div class="btn-group">
        <button id="submit" type="submit"><i class="bi bi-search"></i></button>
        <button id="btn-sr-close"><i class="bi bi-x-lg"></i></button>
      </div>
...
/* 간혹 html이 안먹히는 경우가 있어서 위치를 잘 파악해야한다. */
...
$(function () {
  ...
  // 2. .search-box .search-btn-close 누르면 닫기

  $('#icon-menu .bi-search').click(function () {
    $('.search-box').addClass('on');
  });

  $('.search-box #btn-sr-close').click(function () {

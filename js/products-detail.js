...
function showDetail(obj) {
  ...
  // 해당 id 제품 출력
    ...
    $('#products-detail figure img').attr('src',imgUrl);
    $('#products-detail .container h2').text(name);
    $('#products-detail .prPrice').text(`KRW: ${price}`);
    $('#products-detail .text01').text(text);
